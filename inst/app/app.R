...
server <- function(input, output, session) {
  ...
  output$countryplot <- renderPlotly({
    ...
    plot_all <- dailyall %>%
      ...
      labs(x = "Date",
           ...
           title = "Figure 2: Trend of Daily Confirmed Cases") +
      theme(panel.background = element_rect(fill = "grey16"),
            plot.background = element_rect(fill = "grey16"),
            panel.grid.major = element_blank(),
            panel.grid.minor = element_blank(),
  ...
  output$dailydeath <- renderPlotly({
    ...
    plot_all <- dailyall %>%
      ...
      labs(x = "Date",
           ...
           title = "Figure 3: Trend of Daily Number of Deaths") +
      theme(panel.background = element_rect(fill = "grey16"),
            plot.background = element_rect(fill = "grey16"),
            panel.grid.major = element_blank(),
            panel.grid.minor = element_blank(),
  ...
  output$dailyrecovered <- renderPlotly({
    ...
    plot_all <- dailyall %>%
      ...
      geom_smooth(color = "red", size = 1) +
      labs(x = "Date",
           y = "Daily number of recovered",
           title = "Figure 4: Trend of Daily Number of Recovered") +
      theme(panel.background = element_rect(fill = "grey16"),
            plot.background = element_rect(fill = "grey16"),
            panel.grid.major = element_blank(),
            panel.grid.minor = element_blank(),
